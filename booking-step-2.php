            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="instructions-wrapper">
                        <ul class="custom-ul">
                            <li>
                                <p> جولة مع شارح متخصص </p>
                            </li>

                            <li>
                                <p> دخول الأطفال أقل من 6 سنوات مجاناً (لا يشمل دخول السينما) </p>
                            </li>

                            <li>
                                <p> دخول ذوى الإعاقة مع تقديم ما يثبت عند الدخول (لا يشمل دخول السينما) </p>
                            </li>
